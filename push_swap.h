...
/*   Updated: 2024/01/02 10:43:39 by vda-conc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_iteration_data
{
	t_list	*list_a;
...
t_list		*ft_create_and_link_node(t_list *src, t_list **head,
				t_list **current);
...
int			multiple_rotates_down_lower(int *position1, int *position2,
				int *cost, t_costs_info infos);
int			multiple_rotates_down_greater(int *position1, int *position2,
				int *cost, t_costs_info infos);
int			multiple_rotates_up_lower(int *position1, int *position2,
				int *cost);
int			multiple_rotates_up_greater(int *position1, int *position2,
				int *cost);
...
void		ft_push_to_b(t_list **list_a, t_list **list_b, int total_size,
				char **instructions);
void		ft_push_to_a(t_list *node, t_list *target_node,
				t_list_container *lists, char **instructions);
void		ft_pb_by_three_groups(t_list **list_a, t_list **list_b,
				int total_size, char **instructions);
void		ft_push_by_group(t_list **list_a, t_list **list_b,
				char **instructions);
