...
/*   Updated: 2023/12/16 16:23:55 by vk               ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_cost(int a_node_pos, int b_node_pos, t_list **list_a, t_list **list_b)
{
  ...
  cost = 0;
  ft_multiple_costs(&cost, &a_node_pos, &b_node_pos, list_a_size, list_b_size);
  ft_single_cost_a(&cost, &a_node_pos, list_a_size);
  ft_single_cost_a(&cost, &b_node_pos, list_b_size);
  return (cost);
}
...
void ft_multiple_costs(int *cost, int *a_node_pos, int *b_node_pos, int a_size, int b_size)
{
